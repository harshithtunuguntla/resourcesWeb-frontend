...
const PipelineWeb = () => {
  ...
  const downloadPDF = () => {
    const pdfUrl = process.env.REACT_APP_HUNDRED_PDF_FILE_URL;
        ...
        {isSubmitted ? (
          ...
          <>
            ...
            <div className="header">
              ...
              <div className="mainHeading">
                Access  <span className="highlight">100 Connection Templates Document</span> Here!
              </div>
